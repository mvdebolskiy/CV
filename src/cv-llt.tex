...
\leftheader{%
  {\LARGE\bfseries\sffamily Matvey V. Debolskiy}

  \makefield{\faEnvelopeO}{\texttt{matveyd@uio.no}}
  
   \makefield{\faEnvelopeO}{\texttt{nomatdebol@gmail.com}}
  
  %\makefield{\faEnvelopeO}{\texttt{mvdebolskiy@alaska.edu}}

  \makefield{\faGithub}{\hyperlink{https://github.com/mvdebolskiy}{https://github.com/mvdebolskiy}}  
